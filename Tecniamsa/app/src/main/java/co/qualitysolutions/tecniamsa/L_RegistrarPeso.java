...
public class L_RegistrarPeso extends Activity implements View.OnClickListener{
...
public void inicializarComponentes(){
        addWeigth=(Button)findViewById(R.id.addWeigth);
        addWeigth.setOnClickListener(this);
        adicionar=false;
...
public void optener_peso(){
        ...
        {
        if(Address ==null && mBluetoothService.getState()<mBluetoothService.STATE_CONNECTING)
        {
        startActivityForResult(new Intent(getApplicationContext(), D_Dispositivos.class), 20);
        }
        else {
...
public void handleMessage(Message msg) {
        ...
        try {
        nuevoPeso.put("peso_asignado", Double.parseDouble(line.substring(7, line.length() - 3)));
